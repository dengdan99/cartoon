...
class Users extends BaseUc
{
    ...
    public function ucenter()
    {
        ...
        try {
            ...
            Cookie::forever('xwx_vip_expire_time', $user->vip_expire_time); //在cookie里更新用户vip过期时间
            View::assign([
                'balance' => $balance,
                'user' => $user,
                'day' => $day
    ...
    public function promotion()
    {
        ...
        $util = new Common();
        $shortUrl = config('extra_config.schema').config('extra_config.domain').'?pid='.cookie('xwx_user_id');
