...
function(e) {
    ...
    p.prototype.preview = function (e) {
      var i = this;
      // console.log('i.chooseFiles', i.chooseFiles)
    ...
    p.prototype.mpreview = function(e) {
        var i = this;
        var filesNameArr = [];
        var filesArr = [];
        var keyArr = Object.getOwnPropertyNames(this.files);
        keyArr.forEach(function(key,index) {
          var file = i.files[key];
          if(filesNameArr.indexOf(file.name) === -1){
            filesNameArr.push(file.name);
            filesArr.push(file);
          }
        })
        filesArr.sort(function(a,b) {
          // console.log(parseInt(a.name), parseInt(b.name))
          return parseInt(a.name) - parseInt(b.name)
        })
        console.log('this.files', filesArr)
        layui.each(filesArr,
        function(i, t) {
            // var n = new FileReader;
            // n.readAsDataURL(t),
