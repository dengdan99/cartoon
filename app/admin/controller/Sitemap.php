...
class Sitemap extends BaseAdmin
{
    ...
    {
        if ($name == 'pc') {
            $site_name = config('extra_config.schema') . config('extra_config.domain');
        } elseif ($name == 'm') {
            $site_name = config('extra_config.schema').config('extra_config.mobile_domain');
        } elseif ($name == 'mip') {
            $site_name = config('extra_config.schema').config('extra_config.mip_domain');
        }
        if ($part == 'book') {
